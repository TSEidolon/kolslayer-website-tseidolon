      ...
      <div className="h-full flex w-full">
        <section className="flex justify-center items-center gap-10 border-2 w-[60%] pl-10 h-[90%]">
          <div className="border-2  text-xl flex justify-center items-center flex-col min-w-[20%] h-full gap-10">
            ...
            relative  transition-all ease-in-out  after:transition-[width] after:ease-in-out after:duration-500 after:absolute after:bg-black after:origin-center after:h-full after:w-0 hover:after:w-[12%] after:right-[0%]"> Title 1 </p>
