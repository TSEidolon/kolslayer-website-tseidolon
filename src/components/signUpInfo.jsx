        ...
        <h1> Learn More </h1>
          <form className="w-[400px] mx-auto">
            <div className="relative">
              ...
              <input type="text" className="bg-[#315A83] border border-[#315A83]  text-lg rounded-lg focus:outline-none focus:border-white focus:ring-sky-500 block w-full  ps-10 p-2.5 " placeholder="Enter Your Email"/>

              <button type="submit" className="text-xl border-2 border-white p-[5px]"> Newsletter Sign Up </button>
            </div>
          </form>
